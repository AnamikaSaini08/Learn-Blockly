...
const Home = () => {
    ...
    const [robotPosition , setRobotPosition] = useState(gamesConfig.gameConfigOne.robotStartPosition);
  ...
  return (
      ...
      <div className="w-1/2">
        <ThreeDMatrix {...gamesConfig.gameConfigOne} robotPositionRef={robotPositionRef}
          robotPosition ={robotPosition}
          setRobotPosition ={setRobotPosition}
        />
      </div>
